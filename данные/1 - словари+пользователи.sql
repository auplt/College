...
( 'Физика', null)
, ( 'Основы философии', null)
, ( 'Элементы высшей математики', 'Математический анализ, Аналитическая геометрия, Линейная алгебра')
, ( 'Теория вероятностей', 'Теория вероятностей и математическая статистика')
, ( 'Дискретная математика', 'Дискретная математика с элементами математической логики')
, ( 'Экономика', 'Экономическая безопасность')
, ( 'Право', 'Правовое обкспечение профессиональной деятельности')
, ( 'ЧМ', 'Численный методы')
, ( 'ИТ', 'Информационный технологии')
, ( 'БОСС', 'Безопасность операционных систем и сред')
, ( 'Физкультура', null)
;
