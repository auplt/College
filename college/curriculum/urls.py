...
urlpatterns = [
    ...
    re_path(r'register/?(?P<group_id>\d+)?&?(?P<semester_num>\d+)?/?', views.curriculum_register,
            name='curriculum_register'),
    re_path(r'register/?(?P<group_id>\d+)?/?$', views.curriculum_register, name='curriculum_register'),
    re_path(r'register/?(?P<discipline_id>\d+)?/?$', views.curriculum_register, name='curriculum_register'),
    path('register/', views.curriculum_register, name='curriculum_register'),
    path('delete/<int:curriculum_id>/', views.curriculum_delete,
         name='curriculum_delete'),
    re_path(r'delete/?(?P<discipline_id>\d+)?&?(?P<group_semester_id>\d+)?/?', views.curriculum_delete,
