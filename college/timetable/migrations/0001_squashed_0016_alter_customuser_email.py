...
class Migration(migrations.Migration):
    ...
    replaces = [('timetable', '0001_squashed_0002_tutors_students_constraints'), ('timetable', '0003_lessontime_name'), ('timetable', '0004_classroom_description'), ('timetable', '0005_alter_classroom_number'), ('timetable', '0006_groupsemester_group_semester_num_unique'), ('timetable', '0007_curriculum_discipline_group_sem_unique'), ('timetable', '0008_rename_group_semesters_groupmember_group_semester_id'), ('timetable', '0009_alter_student_user_id_alter_tutor_user_id_and_more'), ('timetable', '0010_alter_student_user_id_alter_tutor_user_id'), ('timetable', '0011_alter_classroom_table_alter_coefficient_table_and_more'), ('timetable', '0012_remove_ttlesson_tt_lesson_day_time_curriculum_les_unique_and_more'), ('timetable', '0013_rename_lessons_time_id_ttlesson_lesson_time_id'), ('timetable', '0014_alter_ttlesson_lesson_time_id'), ('timetable', '0015_remove_ttlesson_tt_lesson_day_week_time_curriculum_les_unique_and_more'), ('timetable', '0016_alter_customuser_email')]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='lessontime',
            name='name',
            field=models.CharField(default='No', max_length=64, unique=True),
        ...
        migrations.RenameField(
            model_name='groupmember',
            old_name='group_semesters',
            new_name='group_semester_id',
        ),
        migrations.AlterField(
            model_name='student',
            name='user_id',
            field=models.ForeignKey(db_column='user_id', on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL, unique=True),
        ),
        migrations.AlterField(
            model_name='tutor',
            name='user_id',
        ...
        migrations.AddConstraint(
            model_name='ttlesson',
            constraint=models.UniqueConstraint(fields=('day_name', 'curriculum_lesson_id', 'lessons_time_id'), name='tt_lesson_day_time_curriculum_les_unique'),
        ),
        migrations.AlterField(
            model_name='student',
            name='user_id',
        ...
        migrations.AlterModelTable(
            name='studentattendance',
            table='students_attendances',
        ),
        migrations.AlterModelTable(
            name='studentprogress',
            table='students_progresses',
        ),
        migrations.AlterModelTable(
            name='ttlesson',
            table='tt_lessons',
        ...
        migrations.RemoveConstraint(
            model_name='ttlesson',
            name='tt_lesson_day_time_curriculum_les_unique',
        ),
        migrations.AddConstraint(
            model_name='ttlesson',
            constraint=models.UniqueConstraint(fields=('day_name', 'week_type', 'curriculum_lesson_id', 'lessons_time_id'), name='tt_lesson_day_week_time_curriculum_les_unique'),
        ),
        migrations.RenameField(
            model_name='ttlesson',
            old_name='lessons_time_id',
            new_name='lesson_time_id',
        ),
        migrations.AlterField(
            model_name='ttlesson',
            name='lesson_time_id',
        ...
        migrations.AddConstraint(
            model_name='ttlesson',
            constraint=models.UniqueConstraint(fields=('day_name', 'week_type', 'curriculum_lesson_id', 'lesson_time_id'), name='tt_lesson_day_week_time_curriculum_les_unique'),
        ),
        migrations.AlterField(
